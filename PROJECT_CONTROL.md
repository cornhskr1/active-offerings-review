...
**Current task:** **NCAA Soccer — resolve 1 combined Men-and-Women approval**
...
|---|---|---|---|
| 1. Competition identities | **IN PROGRESS** | 68 of 74 combined approvals resolved; 6 remain | 74/74 resolved; no false combined schedulable identities |
...
Already resolved: Soccer 22, Basketball 13, NCAA Basketball 3, Rugby 5, Surfing 3, Table Tennis 2, Tennis 8, Volleyball 9, NCAA Golf 1, NCAA Ice Hockey 1, and NCAA Lacrosse 1. Table Tennis includes one evidence-backed single mixed-gender MLTT competition; Tennis includes one evidence-backed single mixed-team United Cup competition.
...
**Current checkpoint:** Priority 1; NCAA Soccer; Active Offerings PR #79 merged; 68 of 74 combined approvals resolved after NCAA Lacrosse; expected after NCAA Soccer: 69 of 74.
