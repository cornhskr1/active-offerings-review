...
**Current task:** **NCAA Tennis — resolve 1 combined Men-and-Women approval**
...
|---|---|---|---|
| 1. Competition identities | **IN PROGRESS** | 70 of 74 combined approvals resolved; 4 remain | 74/74 resolved; no false combined schedulable identities |
...
| 11 | NCAA Tennis | 1 | **NEXT** |
| 12 | NCAA Track and Field | 2 | Pending |
| 13 | NCAA Water Polo | 1 | Pending |
|  | **Remaining** | **4** |  |

Already resolved: Soccer 22, Basketball 13, NCAA Basketball 3, Rugby 5, Surfing 3, Table Tennis 2, Tennis 8, Volleyball 9, NCAA Golf 1, NCAA Ice Hockey 1, NCAA Lacrosse 1, NCAA Soccer 1, and NCAA Swimming 1. Table Tennis includes one evidence-backed single mixed-gender MLTT competition; Tennis includes one evidence-backed single mixed-team United Cup competition.
...
**Current checkpoint:** Priority 1; NCAA Tennis; Active Offerings PR #82 merged; 70 of 74 combined approvals resolved after NCAA Swimming; expected after NCAA Tennis: 71 of 74.
