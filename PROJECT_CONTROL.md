...
**Current task:** **NCAA Swimming — resolve 1 combined Men-and-Women approval**
...
|---|---|---|---|
| 1. Competition identities | **IN PROGRESS** | 69 of 74 combined approvals resolved; 5 remain | 74/74 resolved; no false combined schedulable identities |
...
| 10 | NCAA Swimming | 1 | **NEXT** |
| 11 | NCAA Tennis | 1 | Pending |
| 12 | NCAA Track and Field | 2 | Pending |
| 13 | NCAA Water Polo | 1 | Pending |
|  | **Remaining** | **5** |  |

Already resolved: Soccer 22, Basketball 13, NCAA Basketball 3, Rugby 5, Surfing 3, Table Tennis 2, Tennis 8, Volleyball 9, NCAA Golf 1, NCAA Ice Hockey 1, NCAA Lacrosse 1, and NCAA Soccer 1. Table Tennis includes one evidence-backed single mixed-gender MLTT competition; Tennis includes one evidence-backed single mixed-team United Cup competition.
...
**Current checkpoint:** Priority 1; NCAA Swimming; Active Offerings PR #80 merged; 69 of 74 combined approvals resolved after NCAA Soccer; expected after NCAA Swimming: 70 of 74.
