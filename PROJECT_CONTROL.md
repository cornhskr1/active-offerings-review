...
**Current task:** **NCAA Lacrosse — resolve 1 combined Men-and-Women approval**
...
|---|---|---|---|
| 1. Competition identities | **IN PROGRESS** | 67 of 74 combined approvals resolved; 7 remain | 74/74 resolved; no false combined schedulable identities |
...
Already resolved: Soccer 22, Basketball 13, NCAA Basketball 3, Rugby 5, Surfing 3, Table Tennis 2, Tennis 8, Volleyball 9, NCAA Golf 1, and NCAA Ice Hockey 1. Table Tennis includes one evidence-backed single mixed-gender MLTT competition; Tennis includes one evidence-backed single mixed-team United Cup competition.
...
**Current checkpoint:** Priority 1; NCAA Lacrosse; Active Offerings PR #78 merged; 67 of 74 combined approvals resolved; expected after NCAA Lacrosse: 68 of 74.
