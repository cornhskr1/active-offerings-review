"""NCAA Division I men's and women's lacrosse require distinct identities."""
...
class NCAALacrosseDivisionIdentityTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def approval(self):
        sport = next(
            item for item in self.season["sports"] if item["sport"] == "NCAA Lacrosse"
        )
        return next(
            event
