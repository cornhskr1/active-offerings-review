...
class VolleyballDivisionIdentityTests(unittest.TestCase):
    ...
    def test_all_nine_approvals_have_distinct_operational_children(self):
        ...
        for approval in combined:
            ...
            if approval["key"] in {"volleyball-fivb-beach-pro-tour", "volleyball-cev-champions-league", "volleyball-fivb-vnl", "volleyball-fivb-world-championships", "volleyball-fivb-club-world"}:
