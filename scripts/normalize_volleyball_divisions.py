#!/usr/bin/env python3
"""Split combined Volleyball approvals into separate operational identities."""
...
def normalize(payload):
    volleyball = next(
        sport for sport in payload["sports"] if sport["sport"] == "Volleyball"
    )
    for group in volleyball["groups"]:
